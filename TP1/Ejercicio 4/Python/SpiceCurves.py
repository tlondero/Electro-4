...
if show3con2:
    ...
    giveMe4WithCrop(t_ej3-1, Vgs_ej3, t_ej3-1, Ig_ej3*1e3, t_ej2-(25.5e-6), Vgs_ej2*12/5, t_ej2-(25.5e-6), Ig_ej2*1e3, '$V_{GS} \ [V]$', '$I_G \ [mA]$', 'Tiempo $[\mu s]$', '$V_{GS}$ con MOS', '$I_G$ con MOS', '$V_{GS}$ llave ideal', '$I_G$ llave ideal', [16, 19], [22, 27], [-125, 100])
...
if show3con2:
    ...
    giveMe4(t_ej3-1, Vl_ej3, t_ej3-1, Il_ej3*1e3, t_ej2, Vl_ej2, t_ej2, Il_ej2*1e3, '$V_{L} \ [V]$', '$I_L \ [mA]$', 'Tiempo $[\mu s]$', '$V_{L}$ con MOS', '$V_{L}$ llave ideal', '$I_L$ con MOS', '$I_L$ llave ideal', [0, 50], ylim2=[0, 850])
...
if show3con2:
    ...
    giveMe4(t_ej3-1, Vd_ej3, t_ej3-1, Id_ej3, t_ej2, Vd_ej2, t_ej2, Id_ej2, '$V_{D} \ [V]$', '$I_D \ [A]$', 'Tiempo $[\mu s]$', '$V_{D}$ con MOS', '$I_D$ con MOS', '$V_{D}$ llave ideal', '$I_D$ llave ideal', [0, 50], ylim2=[-2.5, 0.85])
...
if show3con1:
    ...
    giveMe4WithCrop(t_ej3, Vgs_ej3, t_ej3, Ig_ej3*1e3, t_ej1, Vgs_ej1, t_ej1, Ig_ej1*1e3, '$V_{GS} \ [V]$', '$I_G \ [mA]$', 'Tiempo $[\mu s]$', '$V_{GS}$ con carga', '$I_G$ con carga', '$V_{GS}$ sin carga', '$I_G$ sin carga', [16, 18], [22, 27], [-125, 100])
