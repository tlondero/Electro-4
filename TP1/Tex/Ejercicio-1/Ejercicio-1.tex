...
ACA DECIR COMO SE SIMULÓ, CON SPICE O MATLAB ETC.

\subsubsection{Encendido del MOSFET}
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\linewidth]{ImagenesEjercicio-1/pend}%{ImagenesEjercicio-1/sim_encendido_gate}
	\caption{Comparación entre lo simulado y lo calculado para $V_{gs}$ e $I_G$ en el encendido del MOSFET.}
	\label{ej1:fig:sim_encendido_gate}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\linewidth]{ImagenesEjercicio-1/pend}%{ImagenesEjercicio-1/sim_encendido_drain}
	\caption{Comparación entre lo simulado y lo calculado para $V_{ds}$ e $I_D$ en el encendido del MOSFET.}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\linewidth]{ImagenesEjercicio-1/pend}%{ImagenesEjercicio-1/sim_apagado_gate}
	\caption{Comparación entre lo simulado y lo calculado para $V_{gs}$ e $I_G$ en el apagado del MOSFET.}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\linewidth]{ImagenesEjercicio-1/pend}%{ImagenesEjercicio-1/sim_encendido_drain}
	\caption{Comparación entre lo simulado y lo calculado para $V_{ds}$ e $I_D$ en el apagado del MOSFET.}
	\label{ej1:fig:sim_apagado_drain}
\end{figure}

\subsubsection{Régimen Permanente}
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\linewidth]{ImagenesEjercicio-1/pend}%{ImagenesEjercicio-1/permanente_il}
	\caption{Comparación entre lo simulado y lo calculado para el régimen permanente.}
	\label{ej1:fig:permanente_il}
\end{figure}
