...
Para el estudio del modo discontinuo de la fuente estudiada anteriormente, se calculó la corriente media $I_{L_b}$ de boundary de la bobina. El valor anterior de $\Delta I_L$ fue de $494.404mA$, por lo que la corriente media de boundary será
...
Quedando el circuito como se observa en la Figura (\ref{ej4:fig:vds_comp}). A continuación se detallan las curvas simuladas con el snubber en las Figuras (\ref{ej4:fig:vds_snub}) y (\ref{ej4:fig:il_snub}).
