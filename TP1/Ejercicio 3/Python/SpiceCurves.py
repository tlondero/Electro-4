...
giveMe4WithCrop(t_ej3, Vds_ej3, t_ej3, Ids_ej3*1e3, t_ej1, Vds_ej1, t_ej1, Ids_ej1*1e3, '$V_{DS} \ [V]$', '$I_{DS} \ [mA]$', 'Tiempo $[\mu s]$', '$V_{DS}$ con carga', '$I_{DS}$ con carga', '$V_{DS}$ sin carga', '$I_{DS}$ sin carga', [8, 9], [24, 35], [-150, 6000])
