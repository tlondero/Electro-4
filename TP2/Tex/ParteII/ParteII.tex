...
\end{multicols}
La combinación de valores de $R_T$ y $C_T$ fueron elegidas para mantener la frecuenci de switching elegida, la $R_D$ para que se descargue lo mas rápido posible, la $C_{ss}$ para que tenga un comienzo suave.
\begin{figure}[H]
	\centering
...
De esta forma, se selecciona $C = 33 \ nF$. Planteando que tres veces el tiempo característico del sistema RC debe ser menor al período de la fuente Flyback, se puede obtener una restricción similar para la resistencia. Operando, se llega a:
\begin{equation}
