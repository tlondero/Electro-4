...
\end{equation}
Para el gráfico se tomó una resistencia de 0.71 $\Omega$ dado que con este valor satura el transformador.
\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\linewidth]{ImagenesParteII/Eff.png}
	\label{fig:etar}
	\caption{Eficiencia en función de la carga.}
\end{figure}
