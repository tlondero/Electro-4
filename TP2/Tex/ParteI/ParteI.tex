...
Para conseguir una frecuencia de $100 \ kHz$ (a la salida, $\sim$200KHz en el oscilador)basta con tomar:
\begin{equation}
\begin{gathered}
R_T = 2.2 \ k\Omega \\
R_D = 0 \ \Omega \\
...
Para conseguir un Duty deseado, lo que se debe hacer es colocar la salida del amplificador de error a 0 (pin no inversor a masa y pin inversor a $V_{ref}$), luego aplicando una tensión en el pin de compensación (9) podemos manejar el duty de salida. 
